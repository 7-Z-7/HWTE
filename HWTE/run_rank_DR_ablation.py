...
def create_model_SP(bert_config, is_training, input_ids_list, input_mask_list, during_list, position, labels_list, label_mask,sin_position,vocab_size):
        # bert_config, is_training, input_ids, input_mask, segment_ids,
        #          labels, num_labels, use_one_hot_embeddings):
  """Creates a classification model."""
...
def create_model_R(bert_config, is_training, input_ids_list, input_mask_list, during_list, position, labels_list, label_mask,sin_position,vocab_size):
        # bert_config, is_training, input_ids, input_mask, segment_ids,
        #          labels, num_labels, use_one_hot_embeddings):
  """Creates a classification model."""
...
def Drert_SP_fn_builder(bert_config, predict_max_place, init_checkpoint, learning_rate,
                     num_train_steps, num_warmup_steps, use_tpu,
                     use_one_hot_embeddings,sin_position,stop_gradient,gradient_accumulation_multiplier,vocab_size):
  """Returns `model_fn` closure for TPUEstimator."""
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    (total_loss, all_example_loss, logits, probabilities) = create_model_SP(
        bert_config, is_training, input_ids_list, input_mask_list, during_list, position, label_ids_list,
        label_mask_list,sin_position,vocab_size)
...
def Drert_R_fn_builder(bert_config, predict_max_place, init_checkpoint, learning_rate,
                     num_train_steps, num_warmup_steps, use_tpu,
                     use_one_hot_embeddings,sin_position,stop_gradient,gradient_accumulation_multiplier,vocab_size):
  """Returns `model_fn` closure for TPUEstimator."""
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    (total_loss, all_example_loss, logits, probabilities) = create_model_R(
        bert_config, is_training, input_ids_list, input_mask_list, during_list, position, label_ids_list,
        label_mask_list,sin_position,vocab_size)
