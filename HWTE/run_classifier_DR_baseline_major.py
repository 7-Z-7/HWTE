...
class Bigseries10ProcessorBase(DataProcessor):
  """Processor for the CoLA data set (GLUE version)."""
...
class Bigseries8ProcessorBase(DataProcessor):
  """Processor for the CoLA data set (GLUE version)."""
...
def Bert_file_based_input_fn_builder(input_file, seq_length,day_length, is_training,
                                drop_remainder):
  """Creates an `input_fn` closure to be passed to TPUEstimator."""
...
def create_Bert(bert_config, is_training, input_ids_list, input_mask_list, during_list, position, labels, num_labels,sin_position):
        # bert_config, is_training, input_ids, input_mask, segment_ids,
        #          labels, num_labels, use_one_hot_embeddings):
  """Creates a classification model."""
...
def create_Longformer(bert_config, is_training, input_ids_list, input_mask_list, during_list, position, labels, num_labels,sin_position):
        # bert_config, is_training, input_ids, input_mask, segment_ids,
        #          labels, num_labels, use_one_hot_embeddings):
  """Creates a classification model."""
...
def create_Longformer_slid(bert_config, is_training, input_ids_list, input_mask_list, during_list, position, labels, num_labels,sin_position):
        # bert_config, is_training, input_ids, input_mask, segment_ids,
        #          labels, num_labels, use_one_hot_embeddings):
  """Creates a classification model."""
...
def create_Longformer_go(bert_config, is_training, input_ids_list, input_mask_list, during_list, position, labels, num_labels,sin_position):
        # bert_config, is_training, input_ids, input_mask, segment_ids,
        #          labels, num_labels, use_one_hot_embeddings):
  """Creates a classification model."""
...
def create_Performer(bert_config, is_training, input_ids_list, input_mask_list, during_list, position, labels, num_labels,sin_position):
        # bert_config, is_training, input_ids, input_mask, segment_ids,
        #          labels, num_labels, use_one_hot_embeddings):
  """Creates a classification model."""
...
def create_LSTM(bert_config, is_training, input_ids_list, input_mask_list, during_list, position, labels, num_labels,sin_position):
        # bert_config, is_training, input_ids, input_mask, segment_ids,
        #          labels, num_labels, use_one_hot_embeddings):
  """Creates a classification model."""
...
def model_fn_builder_ori(bert_config, num_labels, init_checkpoint, learning_rate,
...
def Bert_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate,
                     num_train_steps, num_warmup_steps, use_tpu,
                     use_one_hot_embeddings,sin_position,stop_gradient,gradient_accumulation_multiplier,binary_threshold,max_length_of_one):
  """Returns `model_fn` closure for TPUEstimator."""
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    (total_loss, per_example_loss, logits, probabilities) = create_Bert(
        bert_config, is_training, input_ids_list, input_mask_list, during_list, position, label_ids,
        num_labels,sin_position)
...
def Longformer_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate,
                     num_train_steps, num_warmup_steps, use_tpu,
                     use_one_hot_embeddings,sin_position,stop_gradient,gradient_accumulation_multiplier,binary_threshold,max_length_of_one):
  """Returns `model_fn` closure for TPUEstimator."""
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    (total_loss, per_example_loss, logits, probabilities) = create_Longformer(
        bert_config, is_training, input_ids_list, input_mask_list, during_list, position, label_ids,
        num_labels,sin_position)
...
def Longformer_slid_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate,
                     num_train_steps, num_warmup_steps, use_tpu,
                     use_one_hot_embeddings,sin_position,stop_gradient,gradient_accumulation_multiplier,binary_threshold,max_length_of_one):
  """Returns `model_fn` closure for TPUEstimator."""
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    (total_loss, per_example_loss, logits, probabilities) = create_Longformer_slid(
        bert_config, is_training, input_ids_list, input_mask_list, during_list, position, label_ids,
        num_labels,sin_position)
...
def Longformer_go_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate,
                     num_train_steps, num_warmup_steps, use_tpu,
                     use_one_hot_embeddings,sin_position,stop_gradient,gradient_accumulation_multiplier,binary_threshold,max_length_of_one):
  """Returns `model_fn` closure for TPUEstimator."""
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    (total_loss, per_example_loss, logits, probabilities) = create_Longformer_go(
        bert_config, is_training, input_ids_list, input_mask_list, during_list, position, label_ids,
        num_labels,sin_position)
...
def Performer_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate,
                     num_train_steps, num_warmup_steps, use_tpu,
                     use_one_hot_embeddings,sin_position,stop_gradient,gradient_accumulation_multiplier,binary_threshold,max_length_of_one):
  """Returns `model_fn` closure for TPUEstimator."""
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    (total_loss, per_example_loss, logits, probabilities) = create_Performer(
        bert_config, is_training, input_ids_list, input_mask_list, during_list, position, label_ids,
        num_labels,sin_position)
...
def LSTM_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate,
                     num_train_steps, num_warmup_steps, use_tpu,
                     use_one_hot_embeddings,sin_position,stop_gradient,gradient_accumulation_multiplier,binary_threshold,max_length_of_one):
  """Returns `model_fn` closure for TPUEstimator."""
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    (total_loss, per_example_loss, logits, probabilities) = create_LSTM(
        bert_config, is_training, input_ids_list, input_mask_list, during_list, position, label_ids,
        num_labels,sin_position)
...
def main(_):
  ...
  processors = {
      ...
      'bigseries10base': Bigseries10ProcessorBase,
      'bigseries8base': Bigseries8ProcessorBase,
  ...
  model_fn_builders = {
      ...
      # 'roBerta':roBerta_fn_builder,      # 'Reformer':Reformer_fn_builder,
